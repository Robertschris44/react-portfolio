...
import headshot from '../../assets/imgHeadshot.jpg';
...
function About() {
    return(
        ...
        <section>
            ...
            <h2>Core Values</h2>
            <ul>
                <li>Be mindfully present with others and engage fully in whatever I am doing</li>
                <li>To be genuine and always to to myself</li>
                <li>It is important that I keep challenging myself to learn, grow, and improve</li>
                <li>Change is good and welcomed</li>
                <li>Simplicity should be used whenever possible</li>
            </ul>
        </section>
    )
}
